...
@NonNullApi
public class TestProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TestProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
